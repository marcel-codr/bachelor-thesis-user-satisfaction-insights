...
Since RAG systems are able to query various data sources at once 

- RAG System allgemein erklären
- Aufgaben
- Qualitätsmetriken 
%---------------------------------------------------------------------%
%------------------------------ Methodology --------------------------%
